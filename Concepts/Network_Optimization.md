...
- [HTTP 2 and HTTP 3](#http-2-and-http-3)
- [Resource Hints (preload, prefetch, preconnect, dns prefetch)](#resource-hints-preload-prefetch-preconnect-dns-prefetch)
- [Caching Strategies](#caching-strategies)
- [Compression (Gzip, Brotli)](#compression-gzip-brotli)
- [CDN (Content Delivery Network)](#cdn-content-delivery-network)
- [Bundle Splitting and Code Splitting](#bundle-splitting-and-code-splitting)
- [Service Workers and Offline Caching](#service-workers-and-offline-caching)
- [103 Early Hints](#103-early-hints)
- [Stale While Revalidate Deep Dive](#stale-while-revalidate-deep-dive)
...
> **Note on Server Push:** HTTP/2 Server Push was designed to let the server proactively send resources before the browser requested them. However, **Chrome removed Server Push support in Chrome 106** (October 2022) due to low adoption and complexity. No major browser actively supports it in practice. Use `<link rel="preload">` or **103 Early Hints** (see [Section 8](#8-103-early-hints)) instead.
